...
export default function Portfolio() {
  ...
  const webProjects = [
    {
      ...
      description:
        'Help with React hooks, props, and clean component structure for maintainable projects.',
      tech: ['React', 'JavaScript'],
    },
    {
      title: 'Three.js & WebGL',
      description:
        'Adding 3D elements or scenes to your React app using Three.js or React Three Fiber.',
      tech: ['React', 'Three.js', 'WebGL'],
    },
    {
      title: 'UI & Styling',
      description:
        'Setting up TailwindCSS or styled-components for responsive, modern UIs that feel smooth.',
      tech: ['React', 'TailwindCSS'],
    },
    {
      title: 'Performance & Optimization',
      description:
        'Improving load times, reducing re-renders, or optimizing 3D and media-heavy sites.',
  ...
  const gameProjects = [
    {
      ...
      description:
        'Help with locomotion setups, ALSv4, animation blending, and melee or ranged combat logic.',
      tech: ['Unreal Engine', 'Blueprints', 'C++'],
    },
    {
      title: 'Replication & Multiplayer',
      description:
        'Fixing issues with desync, variable replication, or getting multiplayer features working smoothly.',
      tech: ['Unreal Engine', 'Replication', 'Networking'],
    },
    {
      title: 'Inventory & Equipment',
      description:
        'Setting up modular inventory, weapon switching, or data-driven item systems that actually scale.',
      tech: ['Unreal Engine', 'Data Assets', 'Blueprints'],
    },
    {
      title: 'Optimization & Debugging',
      description:
        'Tracking down performance drops, cleaning up Blueprints, or figuring out why something just won’t work.',
  ...
  const checkScreenSize = () => {
    const isSmall = window.innerWidth < 768; // Adjust threshold as needed
    setPerformanceMode(isSmall);
  };
      ...
      <header className="fixed top-0 w-full bg-black/80 backdrop-blur-sm border-b border-zinc-800 z-50">
        <nav className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 justify-end">
            {/* Hidden audio controls (kept for reference) */}
            {/* 
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-zinc-400 space-y-4 text-lg">
            ...
            <p>
              ...
              motion matching, ALSv4, combat and melee systems, weapon line tracing (1st & 3rd
      ...
      <section id="projects" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {activeSection === 'web' &&
              webProjects.map((project, i) => <ProjectCard key={i} {...project} />)}
            {activeSection === 'game' &&
              gameProjects.map((project, i) => <ProjectCard key={i} {...project} />)}
          </div>
        </div>
      </section>
